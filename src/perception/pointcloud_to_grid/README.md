...
This repository vendors the package under `src/perception/pointcloud_to_grid` inside the `~/XJTLU-autonomous-vehicle` monorepo.
...
```
Don't forget to `source ~/XJTLU-autonomous-vehicle/install/setup.bash`.
